...
- Archives inbox : inbox/archive/<date>-<short-desc>.md
- Hooks : .claude/hooks/*.sh
- Agents Claude Code : .claude/agents/*.md (uniformisation corps appliquée V4 Delta 2026-05-11, cf docs/v4-delta-doctrine.md — frontmatter Agent natif conservé, corps réorganisé sur template 4 sections obligatoires + 2 recommandées)
- Doctrine 5 registres : Memory/decisions|learnings|blockers|journal|evals.md
- Backlog snapshot : Memory/backlog.md (append-only, alimenté par end-session.ps1)
